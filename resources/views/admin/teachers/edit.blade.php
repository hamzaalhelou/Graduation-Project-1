...
<div class="row align-items-center mb-3 m-8">
    ...
    <div class="col-md-6 ms-20" >
        <input type="text" placeholder="{{ __('admin.Name') }}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('name') is-invalid @enderror" value="{{ $teacher->name }}"  name="name">
        @error('name')
...
<div class="row align-items-center mb-3 m-8">
    ...
    <div class="col-md-6 ms-20" >
        <input type="text" placeholder="{{ __('admin.Position') }}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('position') is-invalid @enderror" value="{{ $teacher->position }}" name="position">
        @error('position')
        <small class="invalid-feedback">{{ $message }}</small>
        @enderror
    </div>
...
<div class="row align-items-center mb-3 m-8">
    ...
    <div class="col-md-6 ms-20" >
        <input type="url" placeholder="{{ __('admin.Link Facebook') }}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('fb_link') is-invalid @enderror" value="{{ $teacher->fb_link }}"name="fb_link">
        @error('fb_link')
        <small class="invalid-feedback">{{ $message }}</small>
        @enderror
    </div>
...
<div class="col-md-6 ms-20" >
    <input type="url" placeholder="{{ __('admin.Link Instagram') }}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('in_link') is-invalid @enderror" value="{{ $teacher->in_link }}" name="in_link">
    @error('in_link')
    <small class="invalid-feedback">{{ $message }}</small>
    @enderror
</div>
...
<div class="row align-items-center mb-3 m-8">
    ...
    <div class="col-md-6 ms-20" >
        <input type="url" placeholder="{{ __('admin.Link Linkedln') }}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('ln_link') is-invalid @enderror" value="{{ $teacher->ln_link }}" name="ln_link">
        @error('ln_link')
       <small class="invalid-feedback">{{ $message }}</small>
       @enderror
    </div>
...
<div class="row align-items-center mb-3 m-8">
    ...
    <div class="col-md-6 ms-20" >
        <input type="url" placeholder="{{ __('admin.Link Gamil') }}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('gm_link') is-invalid @enderror" value="{{ $teacher->gm_link }}" name="gm_link">
        @error('gm_link')
        <small class="invalid-feedback">{{ $message }}</small>
        @enderror
    </div>
