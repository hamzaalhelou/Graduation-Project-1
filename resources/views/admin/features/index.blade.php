...
<table class="table align-middle table-row-dashed fs-6 gy-5">
    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
        <th class="min-w-100px">{{ __('admin.Icon') }}</th>
    ...
    <tbody class="fw-semibold text-gray-600">
        <tr>
            <td>
                <span class="fw-bold">{{ $feature->icon }}</span>
            </td>
            <td>
                <span class="fw-bold">{{ $feature->title }}</span>
            </td>
            <td>
                <span class="fw-bold">{{ Str::limit($feature->content, 30) }}</span>
            </td>
            <td class="fw-bold">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <a href="{{ route('admin.features.show', $feature->id) }}" class="menu-link px-3">{{ __('admin.View') }}</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="{{ route('admin.features.edit', $feature->id) }}" class="menu-link px-3">{{ __('admin.Edit') }}</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    ...
                    <form method="POST" action="{{ route('admin.features.destroy', $feature->id) }}">
                        ...
                        @method('delete')
                        <div class="menu-item px-3">
                        <a class="menu-link px-3"  href="{{ route('admin.features.destroy', $feature->id) }}"
